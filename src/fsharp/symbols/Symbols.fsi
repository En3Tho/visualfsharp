...
type FSharpEntity = 
    ...
    /// Get the fully qualified name of the type or module if it is available
    member TryQualifiedName: string option

    /// Get the fully qualified name of the type or module without strong assembly name
    member QualifiedBaseName: string

    /// Get the fully qualified name of the type or module without strong assembly name if it is available
    member TryQualifiedBaseName: string option

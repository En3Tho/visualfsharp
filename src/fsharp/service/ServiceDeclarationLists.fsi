...
type public FSharpDeclarationListInfo =
    ...
    member Items : FSharpDeclarationListItem seq
    ...
    static member internal Create : infoReader:InfoReader * m:range * denv:DisplayEnv * cenv: SymbolEnv * unresolvedOnly: bool * items:CompletionItem list * unionCaseFieldItems:CompletionItem list * isAttributeApplicationContext:bool -> FSharpDeclarationListInfo
